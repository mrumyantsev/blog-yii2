                        ...
                        <div class="post-content">
                            ...
                            <div class="entry-content">
                                ...
                                <div class="btn-continue-reading text-center text-uppercase">
                                    <a href="<?= Url::toRoute(['site/view', 'id' => $article->id]) ?>" class="more-link"><?= Yii::t('app', 'Continue Reading') ?></a>
                                </div>
                            </div>
                            <div class="social-share">
                                ...
                                <ul class="text-center pull-right">
                                    <li><a class="s-facebook" href="#"><i class="fa fa-eye"></i></a></li><?= (int)$article->view_count ?>
                                </ul>
                            </div>
                        </div>
                    </article>
