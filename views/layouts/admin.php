...
<header id="header">
    ...
    echo Nav::widget([
        ...
        'items' => [
            ['label' => Yii::t('app', 'Back to Application'), 'url' => ['/']],
            ['label' => Yii::t('app', 'Home'), 'url' => ['/admin/default/index']],
            ['label' => Yii::t('app', 'Articles'), 'url' => ['/admin/article/index']],
            ['label' => Yii::t('app', 'Comments'), 'url' => ['/admin/comment/index']],
            ['label' => Yii::t('app', 'Categories'), 'url' => ['/admin/category/index']],
            ['label' => Yii::t('app', 'Tags'), 'url' => ['/admin/tag/index']],
        ]
    ]);
    NavBar::end();
    ?>
