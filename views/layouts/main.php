        ...
        <div class="menu-content">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav text-uppercase">
                    <li><a data-toggle="dropdown" class="dropdown-toggle" href="/"><?= Yii::t('app', 'Home') ?></a>
                    </li>

                    <?php if (Yii::$app->user->identity && Yii::$app->user->identity->is_admin): ?>
                        <li><a data-toggle="dropdown" class="dropdown-toggle" href="/admin"><?= Yii::t('app', 'Admin Panel') ?></a>
                        </li>
                    <?php endif; ?>
                ...
                <div class="i_con">
                    <ul class="nav navbar-nav text-uppercase">
                        <?php if(Yii::$app->user->isGuest): ?>
                            ...
                            <li><a href="<?= Url::toRoute(['auth/signup'])?>"><?= Yii::t('app', 'Register') ?></a></li>
                        <?php else: ?>
...
<footer class="footer-widget-section">
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2025 <a href="#">Treasure PRO, </a> Built with <i
                            class="fa fa-heart"></i> by <a href="#">Rakhim Muratov and Mikhail Rumyantsev</a>
                    </div>
                </div>
            </div>
        </div>
